...
export const REGION_TABLE = [
  ...
  /* 10 ruff          */ { a: [1.05, 1.14, 1.20, 0.55], b: [0.72, 0.95, 1.00, 1.55] },
  /* 11 chest         */ { a: [1.00, 1.18, 1.15, 0.38], b: [0.92, 1.00, 1.00, 0.78] },
  /* 12 shoulder      */ { a: [1.00, 1.00, 1.00, 0.30], b: [0.95, 1.00, 1.00, 0.50] },
  /* 13 back          */ { a: [1.00, 1.02, 0.85, 0.26], b: [0.95, 1.00, 1.00, 0.72] },
  /* 14 flank         */ { a: [1.00, 1.16, 1.15, 0.30], b: [0.90, 1.00, 1.00, 0.80] },
  /* 15 belly         */ { a: [1.00, 1.62, 1.55, 0.42], b: [0.95, 1.05, 0.90, 0.95] },
  /* 16 croup         */ { a: [1.00, 1.04, 0.95, 0.28], b: [0.92, 1.00, 1.00, 0.78] },
  /* 17 haunch        */ { a: [1.00, 1.14, 1.10, 0.30], b: [0.92, 1.00, 1.00, 0.80] },
  /* 18 legFrontUpper */ { a: [1.00, 1.38, 1.05, 0.24], b: [1.10, 1.25, 0.25, 0.70] },
  /* 19 legFrontLower */ { a: [1.00, 1.15, 0.85, 0.24], b: [1.20, 1.45, 0.16, 0.55] },
  /* 20 pawFront      */ { a: [1.00, 1.15, 0.60, 0.16], b: [1.55, 1.95, 0.14, 0.50] },
  /* 21 legHindUpper  */ { a: [1.00, 1.38, 1.10, 0.28], b: [1.05, 1.20, 0.25, 0.70] },
  ...
  /* 25 tailMid       */ { a: [1.06, 1.26, 0.30, 0.42], b: [0.78, 0.92, 1.00, 1.45] },
