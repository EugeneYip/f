...
export const REGION_TABLE = [
  ...
  /* 3 cheek         */ { a: [1.05, 1.90, 1.45, 0.50], b: [0.80, 1.00, 1.00, 1.90] },
  /* 4 forehead      */ { a: [1.00, 0.95, 0.90, 0.10], b: [1.40, 1.20, 0.90, 1.05] },
  /* 5 skull         */ { a: [1.00, 0.98, 0.95, 0.16], b: [1.20, 1.10, 1.00, 1.30] },
  /* 6 earOuter      */ { a: [1.00, 0.86, 0.85, 0.26], b: [1.25, 1.25, 0.90, 1.20] },
  /* 7 earInner      */ { a: [0.90, 0.88, 1.30, 0.55], b: [1.10, 1.15, 0.80, 1.30] },
  /* 8 throat        */ { a: [1.00, 1.30, 1.30, 0.45], b: [0.95, 1.10, 1.00, 1.15] },
  /* 9 neck          */ { a: [1.00, 1.22, 1.10, 0.35], b: [0.90, 1.00, 1.00, 1.05] },
  /* 10 ruff          */ { a: [1.05, 1.32, 1.25, 0.55], b: [0.72, 0.95, 1.00, 1.95] },
  /* 11 chest         */ { a: [1.00, 1.22, 1.15, 0.38], b: [0.92, 1.00, 1.00, 0.95] },
  ...
  /* 15 belly         */ { a: [0.98, 1.50, 1.55, 0.42], b: [0.95, 1.05, 0.90, 1.10] },
  /* 16 croup         */ { a: [1.00, 1.04, 0.95, 0.28], b: [0.92, 1.00, 1.00, 0.95] },
  /* 17 haunch        */ { a: [1.00, 1.02, 1.05, 0.30], b: [0.92, 1.00, 1.00, 0.70] },
  /* 18 legFrontUpper */ { a: [1.00, 1.25, 1.00, 0.24], b: [1.10, 1.25, 0.25, 0.95] },
  /* 19 legFrontLower */ { a: [1.00, 1.45, 0.85, 0.24], b: [1.20, 1.45, 0.16, 0.95] },
  /* 20 pawFront      */ { a: [1.00, 1.40, 0.60, 0.16], b: [1.55, 1.95, 0.14, 0.85] },
  /* 21 legHindUpper  */ { a: [1.00, 1.25, 1.05, 0.28], b: [1.05, 1.20, 0.25, 0.95] },
  /* 22 hock          */ { a: [1.00, 1.25, 0.95, 0.32], b: [1.15, 1.35, 0.16, 1.40] },
  /* 23 pawHind       */ { a: [1.00, 1.40, 0.60, 0.16], b: [1.55, 1.95, 0.14, 0.85] },
  /* 24 tailBase      */ { a: [1.04, 1.28, 0.40, 0.34], b: [0.85, 0.95, 1.00, 1.45] },
  /* 25 tailMid       */ { a: [1.06, 1.42, 0.26, 0.42], b: [0.78, 0.92, 1.00, 1.75] },
  /* 26 tailTip       */ { a: [1.04, 1.34, 0.30, 0.36], b: [0.82, 0.95, 1.00, 1.65] },
];
