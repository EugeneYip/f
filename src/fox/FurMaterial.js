...
export const REGION_TABLE = [
  ...
  /* 4 forehead      */ { a: [1.00, 1.02, 0.90, 0.10], b: [1.40, 1.20, 0.90, 0.95] },
  /* 5 skull         */ { a: [1.00, 0.94, 0.95, 0.16], b: [1.20, 1.10, 1.00, 1.15] },
  ...
  /* 18 legFrontUpper */ { a: [1.00, 0.98, 0.95, 0.24], b: [1.10, 1.25, 0.25, 0.45] },
  /* 19 legFrontLower */ { a: [1.00, 1.35, 0.85, 0.24], b: [1.20, 1.45, 0.16, 0.60] },
  /* 20 pawFront      */ { a: [1.00, 1.30, 0.60, 0.16], b: [1.55, 1.95, 0.14, 0.55] },
  /* 21 legHindUpper  */ { a: [1.00, 1.00, 1.00, 0.28], b: [1.05, 1.20, 0.25, 0.60] },
  /* 22 hock          */ { a: [1.00, 1.12, 0.95, 0.32], b: [1.15, 1.35, 0.16, 1.30] },
  /* 23 pawHind       */ { a: [1.00, 1.30, 0.60, 0.16], b: [1.55, 1.95, 0.14, 0.55] },
